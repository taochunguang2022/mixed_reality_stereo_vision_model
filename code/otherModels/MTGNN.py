...
parser.add_argument('--splittype', type=str, default='random', choices=['random', 'gender'], help='only use for P12 and P19')
parser.add_argument('--reverse', default=False, help='if True, use female for training; if False, use male for training')
...
for missing_ratio in missing_ratios:
    ...
    for k in range(n_splits):
        ...
        for m in range(n_runs):
            ...
            expanded_idx_1 = np.concatenate([idx_1, idx_1], axis=0)
            ...
            for epoch in range(num_epochs):
                ...
                for n in range(n_batches):
                    if strategy == 1:
                        ...
                        """In each batch=32, 16 positive samples, 16 negative samples"""
