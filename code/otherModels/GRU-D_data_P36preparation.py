...
def df_to_x_m_d(df, inputdict, size, id_posistion, split, dataset_name='P36'):
    grouped_data = df.groupby('Time')
    ...
    s_dataset = np.zeros((36, split, size))
...
if __name__ == '__main__':
    dataset_name = 'P36'  # possible values: 'P12', 'P36'
    print('Dataset used: ', dataset_name)

    if dataset_name == 'P36':
        inputpath_1 = '../../P36data/rawdata/djy/'
        inputpath_2 = '../../P36data/rawdata/gxx/'
        inputpath_3 = '../../P36data/rawdata/jsw/'
        inputpath_4 = '../../P36data/rawdata/jxt/'
        inputpath_5 = '../../P36data/rawdata/lfz/'
        inputpath_6 = '../../P36data/rawdata/lh/'
        inputpath_7 = '../../P36data/rawdata/mtq/'
        inputpath_8 = '../../P36data/rawdata/qc/'
        inputpath_9 = '../../P36data/rawdata/qjw/'
        inputpath_10 = '../../P36data/rawdata/zdf/'
        inputpath_11 = '../../P36data/rawdata/zhs/'
        inputpath_12 = '../../P36data/rawdata/zwl/'
        inputpath_13 = '../../P36data/rawdata/zzt/'
        ...
        inputdict = {
            ...
            "O1": 34,
            "O2": 35,
            "RecordID": 36,  # unused variable
            "Gender": 37,  # unused variable
        }
        inputs = []
        ...
        np.save('P36saved/inputs.npy', inputs, allow_pickle=True)
        loaded_inputs = np.load('P36saved/inputs.npy', allow_pickle=True)
        ...
        np.save('P36saved/desc.npy', desc)
        loaded_desc = np.load('P36saved/desc.npy')

        size = 49  # steps ~ from the paper
        id_posistion = 36
        input_length = 36 # input variables ~ from the paper
        dataset = np.zeros((1, 36, input_length, size))
        ...
        np.save('P36saved/x_mean_aft_nor', nor_mean)
        np.save('P36saved/x_median_aft_nor', nor_median)
        np.save('P36saved/dataset.npy', dataset)

        t_dataset = np.load('P36saved/dataset.npy')
        print(t_dataset.shape)

        A_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-djy.txt')
        B_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-gxx.txt')
        C_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-jsw.txt')
        D_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-jxt.txt')
        E_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-lfz.txt')
        F_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-lh.txt')
        G_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-mtq.txt')
        H_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-qc.txt')
        I_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-qjw.txt')
        J_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-zdf.txt')
        K_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-zhs.txt')
        L_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-zwl.txt')
        M_outcomes = pd.read_csv('../../P36data/rawdata/Outcomes-zzt.txt')
        ...
        np.save('P36saved/y1_out', y1_outcomes)
